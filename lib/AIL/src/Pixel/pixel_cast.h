...
template <> __forceinline PixelYb1 pixel_cast<PixelYb1>(const PixelYi1u & _color){
	if(_color.getY()>128){return PixelYb1(true);}return PixelYb1(false);
}
template <> __forceinline PixelYb1 pixel_cast<PixelYb1>(const PixelRGBi1u & _color){
	I8 tempY;
...
template <> __forceinline PixelYb1 pixel_cast<PixelYb1>(const PixelRGBf8 & _color){
	F8 tempY;
...
template <> __forceinline PixelYb1 pixel_cast<PixelYb1>(const PixelYUVf8 & _color){
	if(_color.getY()>0.5){return PixelYb1(true);}return PixelYb1(false);
}
/////////////////////////////////////////////////
/////////////////////////////////////////////////
template <> __forceinline PixelYi1u pixel_cast<PixelYi1u>(const PixelYb1 & _color){
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
template <> __forceinline PixelRGBi1u pixel_cast<PixelRGBi1u>(const PixelYb1 & _color){
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
template <> __forceinline PixelRGBf8 pixel_cast<PixelRGBf8>(const PixelYb1 & _color){
...
/////////////////////////////////////////////////
/////////////////////////////////////////////////
template <> __forceinline PixelYUVf8 pixel_cast<PixelYUVf8>(const PixelYb1 & _color){
...
template <> __forceinline PixelYb1    pixel_cast<PixelYb1   >(const PixelYb1    & _color){return _color;}
