	...
	: public ImageOperation<PixelType>
{
	...
	public:
		...
		BlackTopHatFilter(const I4 & _iterations):iterations(_iterations),type(MorphKernelType::getSquare()){};
		BlackTopHatFilter(const I4 & _iterations,const MorphKernelType & _type):iterations(_iterations),type(_type){};
