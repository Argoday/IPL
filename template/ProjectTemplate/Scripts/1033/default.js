...
function CreateCustomProject(strProjectName, strProjectPath){
	try{
		...
		strProjectNameWithExt = strProjectName + 'd.vcxproj';
...
function GetTargetName(strName, strProjectName){
	try{
		...
		if (strName == 'project.h'){
			var strProjectName = wizard.FindSymbol('PROJECT_NAME');
			strTarget = 'src/' + strProjectName + '.h';
		}
		if (strName == 'property.props'){
			var strProjectName = wizard.FindSymbol('PROJECT_NAME');
			strTarget = strProjectName + '.props';
		}
		if (strName == 'default.vcxproj'){
			var strProjectName = wizard.FindSymbol('PROJECT_NAME');
			strTarget = strProjectName + '.vcxproj';
		}
		return strTarget;
	}catch(e){
		throw e;
