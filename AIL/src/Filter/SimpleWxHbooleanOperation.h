...
{
	protected:
		mutable Image::ImageKernel<Pixel::PixelGRAYb,Image::BooleanTestType> filterData;
		long xOffset;
		long yOffset;

	public:

		__forceinline const Image::ImageKernel<Pixel::PixelGRAYb,Image::BooleanTestType> &getFilterData() const {return filterData;}
